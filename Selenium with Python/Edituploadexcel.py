...
import openpyxl  #pkg for excel importing
...
def update_excel_data(filePath, searchTerm, colName, new_value):
    ...
    for i in range(1, sheet.max_row + 1): #this will update any row any column from the Excel
...
file_path = "C:/Users/AH012/Downloads/download.xlsx"
fruit_name = "Apple"
newValue = "1000"
